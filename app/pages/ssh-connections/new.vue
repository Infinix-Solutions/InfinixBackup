  ...
  <div class="py-8 px-6 lg:px-8">
    ...
    <div class="grid grid-cols-2 gap-6">
      ...
      <div class="space-y-4">
        ...
        <template v-else>
          <UAlert color="success" icon="i-lucide-server"
      ...
      <UCard class="h-full">
        <template #header>
          <div class="flex items-center gap-2">
            ...
            <div v-if="savedConnection" class="ml-auto flex items-center gap-1">
              <UButton
        ...
        <template v-if="savedConnection">
          <div class="mt-3 pt-3 border-t border-default">
            <p class="text-xs text-muted mb-1.5">{{ t('ssh.public_key_label') }}</p>
          ...
          <div v-if="!savedConnection.keyInstalling" class="mt-3 rounded-lg border border-amber-500/30 bg-amber-500/5 px-4 py-3 flex gap-3">
